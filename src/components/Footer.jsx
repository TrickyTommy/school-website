    ...
    const Footer = () => {
      ...
      return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <a href="tel:(0267)8658659" className="hover:text-purple-400 transition-colors">(0267) 865-8659</a>
            </p>
            <p className="text-sm flex items-center">
          <Mail className="w-4 h-4 mr-2 text-purple-400" />
          <a href="mailto:websmkbmkrw@gmail.com" className="hover:text-purple-400 transition-colors">websmkbmkrw@gmail.com</a>
            </p>
          </div>
